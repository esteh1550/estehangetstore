      ...
      <div className="relative aspect-[21/9] md:aspect-[3/1] rounded-2xl overflow-hidden shadow-xl group">
        <AnimatePresence mode="wait">
          <motion.div
            ...
            className={cn("absolute inset-0 flex items-center px-8 md:px-20", BANNERS[current].color)}
          >
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center w-full">
              <div className="space-y-4 text-center md:text-left">
                <motion.h2 
                  ...
                  className="text-3xl md:text-6xl font-display font-bold text-black"
                >
                ...
                <motion.p 
                  ...
                  className="text-sm md:text-xl text-black font-medium"
                >
